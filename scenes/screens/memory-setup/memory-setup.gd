...
func _populate_level_info() -> void:
	var level_idx: int = GameManager.totalMiniGamesPlayed if GameManager else 0
	var grid_size: Vector2i = Vector2i(2, 2)  # Use placeholder for now
...
func _on_start_pressed() -> void:
	if GameManager:
		GameManager.change_screen("Memory")
